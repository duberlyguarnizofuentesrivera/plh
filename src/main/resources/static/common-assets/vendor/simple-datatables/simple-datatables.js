        ...
        1: [function (require, module, exports) {
                    ...
                    Promise.all(p).then((n => {
                        ...
                        Array.from(r).forEach((e => {
                            ...
                            a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i, parseFloat(a) == a ? h[d++] = {
                                value: Number(a),
                                row: e
                            } : o[l++] = {value: "string" == typeof i ? i.toLowerCase() : i, row: e}
            ...
            exports.DataTable = class {
                ...
                render() {
                    ...
                    if (this.headings = [], this.hasHeadings = this.head.rows.length > 0, this.hasHeadings && (this.header = this.head.rows[0], this.headings = [].slice.call(this.header.cells)), this.options.header || this.head && this.dom.removeChild(this.dom.tHead), this.options.footer ? this.head && !this.foot && (this.foot = e("tfoot", {html: this.head.innerHTML}), this.dom.appendChild(this.foot)) : this.foot && this.dom.removeChild(this.dom.tFoot), this.wrapper = e("div", {class: "dataTable-wrapper dataTable-loading"}), t += "<div class='dataTable-top'>", t += this.options.layout.top, t += "</div>", this.options.scrollY.length ? t += `<div class='dataTable-container' style='height: ${this.options.scrollY}; overflow-Y: auto;'></div>` : t += "<div class='dataTable-container'></div>", t += "<div class='dataTable-bottom'>", t += this.options.layout.bottom, t += "</div>", t = t.replace("{info}", this.options.paging ? "<div class='dataTable-info'></div>" : ""), this.options.paging && this.options.perPageSelect) {
                        ...
                        this.options.perPageSelect.forEach((t => {
                            const e = t === this.options.perPage, s = new Option(t, t, e, e);
                            i.add(s)
                ...
                renderPager() {
                    if (s(this.pagers), this.totalPages > 1) {
                        ...
                        this.options.truncatePager && (r = ((t, s, i, a, n) => {
                            ...
                            for (let e = 1; e <= i; e++) if (1 == e || e == i || e >= h && e <= l) {
                                const s = t[e - 1];
                ...
                export(e) {
                    ...
                    if (l.type) {
                        if ("txt" !== l.type && "csv" !== l.type || (i[0] = this.header), l.selection) if (isNaN(l.selection)) {
                            if (Array.isArray(l.selection)) for (n = 0; n < l.selection.length; n++) i = i.concat(this.pages[l.selection[n] - 1])
                        } else i = i.concat(this.pages[l.selection - 1]); else i = i.concat(this.activeRows);
                        if (i.length) {
                            if ("txt" === l.type || "csv" === l.type) {
                                for (o = "", n = 0; n < i.length; n++) {
                                    for (r = 0; r < i[n].cells.length; r++) if (!l.skipColumn.includes(s[r].originalCellIndex) && this.columns.visible(s[r].originalCellIndex)) {
                                ...
                                for (r = 0; r < i.length; r++) for (a[r] = a[r] || {}, n = 0; n < s.length; n++) !l.skipColumn.includes(s[n].originalCellIndex) && this.columns.visible(s[n].originalCellIndex) && (a[r][s[n].textContent] = i[r].cells[n].textContent);
                ...
                setMessage(t) {
                    let s = 1;
                    this.hasRows ? s = this.data[0].cells.length : this.activeHeadings.length && (s = this.activeHeadings.length), this.wrapper.classList.add("dataTable-empty"), this.label && (this.label.innerHTML = ""), this.totalPages = 0, this.renderPager(), this.clear(e("tr", {html: `<td class="dataTables-empty" colspan="${s}">${t}</td>`}))
                }
